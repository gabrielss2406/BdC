<?php
/* Smarty version 3.1.33, created on 2019-10-15 21:34:12
  from 'C:\xampp\htdocs\aulaphp\mvc2\views\contact.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5da61f3483fd69_89469059',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a455599823b854d763ef205aba41e4cb5ae71275' => 
    array (
      0 => 'C:\\xampp\\htdocs\\aulaphp\\mvc2\\views\\contact.html',
      1 => 1571167414,
      2 => 'file',
    ),
  ),
...
function content_5da61f3483fd69_89469059 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  <head>
...
" class="nav-link">Artigos</a></li>
	          <li class="nav-item active"><a href="<?php echo $_smarty_tpl->tpl_vars['GET_CONTATO']->value;?>
...
">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Contato <i class="ion-ios-arrow-forward"></i></span></p>
      ...
      <div class="container">
        	...
        	<div class="col-md-8">
        		<div class="row mb-5">
		          <div class="col-md-4 text-center py-4">
		            ...
		            <p><span>Endereço:</span> Fontes Salgadas, Casa Azul Fortnite Island</p>
		          </div>
		          <div class="col-md-4 text-center border-height py-4">
		          	<div class="icon">
		          		<span class="icon-mobile-phone"></span>
		          	</div>
		            <p><span>Telefone:</span> <a href="tel://1234567920">+55 32 98835-1241</a></p>
		          </div>
		          <div class="col-md-4 text-center py-4">
		          	<div class="icon">
		          		<span class="icon-envelope-o"></span>
		          	</div>
		            <p><span>Email:</span> <a href="mailto:info@yoursite.com">BandoDeCornoBDC@tompero.com</a></p>
		          </div>
		        </div>
          </div>
        </div>
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
          	<h2 class="text-center">Se você tiver alguma dúvida<br>não hesite em nos enviar uma mensagem</h2>
