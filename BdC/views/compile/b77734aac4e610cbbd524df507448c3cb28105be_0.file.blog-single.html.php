<?php
/* Smarty version 3.1.33, created on 2019-10-15 21:34:28
  from 'C:\xampp\htdocs\aulaphp\mvc2\views\blog-single.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5da61f44ae3532_81040020',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b77734aac4e610cbbd524df507448c3cb28105be' => 
    array (
      0 => 'C:\\xampp\\htdocs\\aulaphp\\mvc2\\views\\blog-single.html',
      1 => 1571167449,
      2 => 'file',
    ),
  ),
...
function content_5da61f44ae3532_81040020 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
  <head>
...
">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="blog.html">Artigos <i class="ion-ios-arrow-forward"></i></a></span> <span>Python <i class="ion-ios-arrow-forward"></i></span></p>
            <h1 class="mb-3 bread">Python na IA - Básico de IA</h1>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 order-md-last ftco-animate">
            <h2 class="mb-3">A inteligência artificial entra no projeto em diversas partes</h2>
            <p>As aplicações de inteligência artificial (IA) são diversas, e muitas são bem impressionantes. A tecnologia pode ser usada para auxiliar carros autônomos a enxergarem placas de trânsito, gerar sistemas capazes de criar imagens inéditas e realistas e uma infinidade de outras utilidades surpreendentes, como assistentes de voz e responder dúvidas sobre suas férias.</p>
            <p>
              <img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/image_7.jpg" alt="" class="img-fluid">
            </p>
            <p>Por outro lado, criar um sistema de inteligência artificial é um projeto bem distinto de outras tarefas de desenvolvimento. Para ser bem tocado, ele exige não apenas uma experiência prática com programação como também um conhecimento acadêmico sobre os fundamentos de IA e machine learning. Essa diferença pode causar turbulências quando um programador vai de uma área para a outra.</p>
            <h2 class="mb-3 mt-5">Como programar uma IA na prática?</h2>
            <p>Humberto Sandmann é pesquisador de IA da RockSpoon. A empresa está desenvolvendo uma ferramenta (que ainda não chegou ao mercado) que usa inteligência artificial para dar recomendações de restaurantes a pessoas que costumam comer fora.</p>
            <p>
              <img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/image_8.jpg" alt="" class="img-fluid">
            </p>
            <p>A ferramenta funcionará tanto para que os restaurantes se cadastrem quanto para que as pessoas recebam recomendações. Essas recomendações serão feitas com base no gosto daquele usuário, como o que ele gosta de comer, quais são suas restrições alimentares e qual é o tipo de ambiente que ele curte.</p>
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio mr-5">
                <img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc">
                <h3>Gabriel Siqueira</h3>
                <p>Aprendendo Python por que quer tentar fazer uma IA ae</p>
              </div>
            </div>
            ...
            <div class="pt-5 mt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/person_1.jpg" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                    <h3>Leonardo Maia</h3>
                    <div class="meta">08 de Outubro, 2019 às 18:43</div>
                    <p>Finalmente, Humberto cita a boa prática mais importante de todas para trabalhar com inteligência artificial: o estudo contínuo. “Você tem que estudar. As ferramentas e os frameworks não vão resolver os problemas por você.”</p>
          ...
          <div class="col-md-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              ...
              <div class="block-21 mb-4 d-flex">
                <a class="blog-img mr-4" style="background-image: url(<?php echo $_smarty_tpl->tpl_vars['GET_TEMA']->value;?>
/images/image_1.jpg);"></a>
                <div class="text">
